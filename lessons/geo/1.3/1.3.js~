...
var videos = ["Scp40aPgazw", "DIzYSCpHI6A", "L3L58N2PSRE", "_3Lb-rydX4k"];
var correctEq;
var quizEq;
var numEqs = 2;
...
function setQuestion()
{
    ...
    equations = [["distance.gif",
			...
			+"</span>"
                    +"<span style='font-size:300%'>)</span>"
                    +" =&nbsp;(<input type='number' class='mathinput' step='0.1' id='i6' />, <input type='number' class='mathinput' step='0.1' id='i7' />)",
                    [[vars[0], vars[2], 2, vars[1], vars[3], 2, (vars[0]+vars[2])/2, (vars[1]+vars[3])/2],
                     [vars[0], vars[2], 2, vars[3], vars[1], 2, (vars[0]+vars[2])/2, (vars[1]+vars[3])/2],
		     [vars[2], vars[0], 2, vars[1], vars[3], 2, (vars[0]+vars[2])/2, (vars[1]+vars[3])/2],
		     ...
		     [[ans]]],
		    ["added.gif",
                    "(<input type='number' class='mathinput' step='0.1' id='i0' />, <input type='number' class='mathinput' step='0.1' id='i1' />)",

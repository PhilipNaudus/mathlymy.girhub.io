...
function setQuestion()
{
    ...
    var ifRigid;
    var mixup = getRandom(5,9,1);
    var rigid = getRandom(10,14,1);
    ...
    if(questionNum<10) quest = ": What type of transformation has been performed on the purple figure to produce the red figure?";
    else quest = "Is the transformation shown below (from the purple figure to the red figure) a rigid transformation?";

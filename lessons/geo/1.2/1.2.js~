...
var videos = ["un1YXbfM3OQ", "Igx2vBA6iLs", "un1YXbfM3OQ", "Igx2vBA6iLs"];
...
function setQuestion()
{
    ...
    switch(questionNum)
    {
        ...
        case 3:
            var w = Math.min(window.innerWidth, window.innerHeight, 400);
            document.getElementById("question").innerHTML = "Plot A(-4,"+vars[1]+"), B("+vars[0]+","+vars[1]+"), C("+vars[1]+",-4), and D("+vars[1]+","+(vars[0]-ifCon)+") in a coordinate plane. Then determine whether AB and CD are congruent.<br />Please enter yes or no.";
	    equationNum = 0;
            break;
    }
    ans = (ifCon==0)?"yes":"no";

...
var videos = ["5D0bDGkA2iM", "fJBYgY5SGXU", "WygofrPwYp8", "mrdw72OQ-sM"];
...
function setQuestion()
{
    ...
    equations = [["", alph[0]+" = <input type='text' class='mathinput' id='i0' />", [[alph[0]]]],
	        ["", "If "+alph[0]+" = <input type='text' class='mathinput' id='i0' />, then "+alph[1]+" = <input type='text' class='mathinput' id='i1' />", [[alph[1], alph[0]]]],

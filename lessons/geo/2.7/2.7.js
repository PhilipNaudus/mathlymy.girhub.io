...
function setQuestion()
{
    ...
    equations = [["", "<table border='0'><tr><td>&ang;A and &ang;B are right angles</td><td>&nbsp;&nbsp;&nbsp;</td><td><select class='mathinput' id='i0'>"+options+"</select></td></tr>"
		...
		["", "<table border='0'><tr><td>&ang;A and &ang;B are supplements and &ang;B and &ang;C are supplements</td><td>&nbsp;&nbsp;&nbsp;</td><td><select class='mathinput' id='i0'>"+options+"</select></td></tr>"
		    ...
		    +"<tr><td>m&ang;B = m&ang;C</td><td></td><td><select class='mathinput' id='i4'>"+options+"</select></td></tr>"
		    +"<tr><td>&ang;B &cong; &ang;B</td><td>&nbsp;&nbsp;&nbsp;</td><td><select class='mathinput' id='i4'>"+options+"</select></td></tr>"
		    , [["Given", "Definition of perpendicular lines", "Definition of supplementary angles", "Transitive Property of Equality", "Subtraction Property of Equality", "Definition of congruent angles"]]]];
}

...
function setQuestion()
{
    ...
    quest = "Please factor the perfect squares:<br />"+(vars[0]*vars[0])+"x<sup>2</sup> + "+(2*vars[0]*vars[1])+"x + "+(vars[1]*vars[1]);
	    ...
	    quest = "Please factor:<br />"+Math.pow(vars[0],3)+"x<sup>3</sup> "+posNeg+" "+Math.pow(vars[1],3)+"<br /><em>Hint:</em><sup>3</sup><div class='sqrt'><span class='overline'>"+Math.pow(vars[0],3)+"</span></div> = "+vars[0];

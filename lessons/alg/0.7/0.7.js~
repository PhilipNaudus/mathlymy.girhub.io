...
function setQuestion()
{
    ...
    switch(questionNum)
    {
	    ...
	    eq = "<span class='fraction'>"
		       ...
		       +"<span class='fracbot'><input type='number' class='mathinput' id='i4' /></span>"
		   +"</span>";
	    ans = [[vars[2], vars[3], vars[6], vars[7], 1],
		  [vars[6], vars[7], vars[2], vars[3], 1]];
            break;
        case 6:
        case 7:
	    var vars = getRandom(1, 9, 8, [8]);

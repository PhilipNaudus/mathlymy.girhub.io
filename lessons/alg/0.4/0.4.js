...
var videos = ["WoChhHouHgM", "zy1CNakunq8", "zy1CNakunq8", "4VfT97Tn0gc", "4VfT97Tn0gc", "tT8tcWtFlwA", "tT8tcWtFlwA"];
...
function setQuestion()
{
    ...
    switch(questionNum)
    {
	    ...
	    eq = "Coefficient: <input type='number' class='mathinput' id='i0' /><br />Degree: <input type='number' class='mathinput' id='i1' />";
	    ans = [vars[0], vars[1]];
	    equationNum = 0;
            break;
        case 1:
	    ...
	    quest = "Please find the degree of the polynomial<br />"+vars[0]+"x<sup>"+vars[1]+"</sup> + "+vars[2]+"x<sup>"+vars[3]+"</sup> + "+vars[4]+"x<sup>"+vars[5]+"</sup>"
	    ...
	    quest = "Please add the polynomials:<br />("+vars[0]+"x<sup>"+vars[1]+"</sup> + "+vars[2]+"x<sup>"+vars[3]+"</sup>) + ("+vars[4]+"x<sup>"+vars[5]+"</sup> + "+vars[5]+"x<sup>"+vars[6]+"</sup> + "+vars[7]+"x<sup>"+vars[3]+"</sup> + "+vars[8]+"x<sup>"+vars[1]+"</sup>)"
	    ...
	    quest = "Please multiply the polynomials:<br />("+vars[0]+"x + "+vars[1]+") &times; ("+vars[2]+"x + "+vars[3]+")"
        ...
        case 8:
	    var vars = getRandom(1, 9, 4)
	    quest = "Please divide the polynomials:<br />("+(vars[0]*vars[2])+"x<sup>2</sup> + "+((vars[1]*vars[2])+(vars[0]*vars[3]))+"x + "+(vars[1]*vars[3])+") &divide; ("+vars[2]+"x + "+vars[3]+")"

...
function setQuestion()
{
    ...
    switch(questionNum)
    {
	    ...
	    eq = "<input type='number' class='mathinput' id='i0' /><sup>"+vars[1]+"</sup> + <input type='number' class='mathinput' id='i0' /><sup>"+vars[3]+"</sup> + <input type='number' class='mathinput' id='i0' /><sup>"+vars[5]+"</sup> + <input type='number' class='mathinput' id='i0' /><sup>"+vars[6]+"</sup> + ";

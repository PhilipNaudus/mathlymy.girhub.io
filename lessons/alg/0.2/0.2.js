...
var videos = ["K9qv41Hn81Q", "ST4Jq80MWFw", "K9qv41Hn81Q", "ST4Jq80MWFw", "qTkOrL259uI", "qTkOrL259uI", "vu3Oo26rSs8", "vu3Oo26rSs8", "n5Na1JrJrlw", "n5Na1JrJrlw"];
...
function setQuestion()
{
    ...
    switch(questionNum)
    {
	    ...
	    quest = "Please evaluate:<br />|"+vars[0]+" - ["+vars[1]+"&times;"+vars[2]+" + ("+vars[3]+" - "+vars[4]+")] &times; "+vars[5]+"|";

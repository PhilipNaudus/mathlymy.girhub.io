...
function setQuestion()
{
    ...
    switch(questionNum)
    {
	    ...
	    quest = "Please divide the polynomials using synthetic division:<br />("+(vars[0]*vars[2])+"x<sup>2</sup> + "+((vars[1]*vars[2])+(vars[0]*vars[3]))+"x + "+(vars[1]*vars[3])+") &divide; ("+vars[2]+"x + "+vars[3]+")"

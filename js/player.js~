...
function startVideo()
{
    ...
    document.getElementById("playerSpan").innerHTML = "<iframe width='"+w+"' height='"+(w*39/64)+"' src='https://www.youtube.com/embed/"+lessons[get["course"]][get["lessonId"]][0]+"?autoplay=1'></iframe>";
}
